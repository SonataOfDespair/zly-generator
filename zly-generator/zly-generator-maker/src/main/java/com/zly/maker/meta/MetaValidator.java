...
import com.zly.maker.meta.enums.FileGenerateTypeEnum;
import com.zly.maker.meta.enums.FileTypeEnum;
...
public class MetaValidator {
    ...
    public static void validAndFillMetaRoot(Meta meta) {
        ...
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "zly");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.zly");
